...
Benchmark.bm(10) do |bm|
  ...
  bm.report("naive") do
    Prawn::Document.generate("the_prince_naive.pdf", :compress => true) do
      ...
      column_box([0, cursor], :columns => 2, :width => bounds.width) do
        File.open("#{Prawn::BASEDIR}/data/the_prince.txt", "r:UTF-8") do |f|
  ...
  bm.report("ruby") do
    Prawn::Document.generate("the_prince_ruby.pdf", :compress => true) do
      # Open-source font courtesy of: http://www.theleagueofmoveabletype.com/
      font_families.update(
        "GoudyBookletter1911" => {
          :normal => "#{Prawn::BASEDIR}/data/fonts/GoudyBookletter1911.ttf"
  ...
  require 'crawdad/ffi'
  bm.report("ffi") do
    Prawn::Document.generate("the_prince_ffi.pdf", :compress => true) do
      # Open-source font courtesy of: http://www.theleagueofmoveabletype.com/
      font_families.update(
        "GoudyBookletter1911" => {
          :normal => "#{Prawn::BASEDIR}/data/fonts/GoudyBookletter1911.ttf"
