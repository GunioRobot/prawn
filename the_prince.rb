...
Prawn::Document.generate("the_prince.pdf", :compress => true) do
  ...
  # Column box is disabled in edge Prawn, pending refactor.
  #column_box([0, cursor], :columns => 2, :width => bounds.width) do
    mode = (RUBY_VERSION >= '1.9') ? 'r:UTF-8' : 'r'
